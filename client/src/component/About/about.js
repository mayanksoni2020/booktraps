  ...
  return (
    <div>
      ...
      <div className="bookabout">
        <HeadingTitle title="Inspiration" margin="300px 0px 20px 0px"></HeadingTitle>
      ...
      <div >
        ...
        <div style={{ display: "block", margin: "5% 10%", }}>
          ...
          <FAQ question="Who is this for?" answer="This is for all the people who loves to read books and wanted to share their journey with the books they had read so far."></FAQ>
          ...
          <FAQ question="Whom to contact for any query?" color="warning" answer="You can drop a mail at mayanksoni2020@gmail.com " />
          <FAQ question="Can i contribute to this project?" color="primary" answer="Yes, you can contribute to this page. Drop a mail at mayanksoni2020@gmail.com and I will get back to you" />
        </div>
